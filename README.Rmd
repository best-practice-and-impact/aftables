...
* [config file vignette](https://best-practice-and-impact.github.io/aftables/articles/config-file) to understand how to use config files to set workbook properties and formatting
