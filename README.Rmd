...
1. Pass the output to `openxlsx2::wb_save()`
...
* [terminology vignette](https://best-practice-and-impact.github.io/aftables/articles/terminology.html) to understand the nomenclature of spreadsheet terms as used in this package
* [package structure vignette](https://best-practice-and-impact.github.io/aftables/articles/structure.html) to see how the package works under the hood
...
The ONS's Analysis Standards and Pipelines team has released [a Python package called 'gptables'](https://github.com/ONSdigital/gptables). {aftables} is an independent effort that offers a native R solution that is very similar to gptables in its outputs, though there are some differences in implementation.
