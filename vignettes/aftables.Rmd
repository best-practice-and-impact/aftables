...
1. Pass the output to `openxlsx2::saveWorkbook()` to write out to an xlsx file (or `openxlsx2::wb_open()` to open a temporary copy)
...
We can use `generate_workbook()` to convert our aftable to an [{openxlsx2}](https://janmarvin.github.io/openxlsx2/) Workbook-class object.
