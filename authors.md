...
- **Olivia Box Power**. Maintainer, contributor.

- **Zachary Gleisner**. Contributor.

## Citation

Source:
[`inst/CITATION`](https://github.com/best-practice-and-impact/aftables/blob/v2.0.0/inst/CITATION)
...
<https://github.com/best-practice-and-impact/aftables>.
    ...
    @Manual{,
      title = {aftables: Generate spreadsheet publications that follow best practice guidance from the UK government's Analysis Function},
      author = {Matt Dray},
      year = {2021},
